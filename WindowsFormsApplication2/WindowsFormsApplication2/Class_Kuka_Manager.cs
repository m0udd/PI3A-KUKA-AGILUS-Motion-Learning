...
namespace Projet_Kuka
{
    class Class_Kuka_Manager
    {
        ...
        public CartesianPosition Donne_Position()
        {
            if (robot != null)
            {
        ...
        public void stopModeMove()
        {
            isMotionProgressing = false;
        }
